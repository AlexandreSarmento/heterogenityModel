...
nu = 1e-5; % new variants generation rates
...
k = [10 10]; % smoothness of transition between maximal and minimal values of alpha(N), delta(N) and rho(N)
...
save('boxK10K10nu2.mat','data','allPar') % save output file about matrix of data to plot 
