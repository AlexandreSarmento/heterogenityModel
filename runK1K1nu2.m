...
k = [1 1]; % smoothness of transition between maximal and minimal values of alpha(N), delta(N) and rho(N)
...
save('boxK1K1nu2.mat','data','allPar') % save output file about matrix of data to plot 
